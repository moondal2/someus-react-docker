...
const MyDiaryWrite = ({ history }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://${process.env.REACT_APP_REST_API_SERVER_IP}:${process.env.REACT_APP_REST_API_SERVER_PORT}/api/someus/private/write`,
    ...
    const onSubmit = (e) => {
        ...
        axios({
            method: 'post',
            url: `http://${process.env.REACT_APP_REST_API_SERVER_IP}:${process.env.REACT_APP_REST_API_SERVER_PORT}/api/someus/private/write`,
            data: formData,
            headers: {
